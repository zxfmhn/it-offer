                ...
                <table class="tn-table-grid">
                  <tbody>
                    ...
                    <tr class="tn-table-grid-row">
                      ...
                      <td class="tn-width-auto"><a title=易科德软件有限公司  href="#" target="_blank"> 易科德软件有限公司</a></td>
                      <th class="tn-width-pic-mini"> <a title=软件开发工程师/实施工程师 href="#" target="_blank"> 软件开发工程师...</a> </th>
                    ...
                    <tr class="tn-table-grid-row">
                      <td class="tn-width-check"><input type="checkbox" class="tn-checkbox tnui-apply" value="493" name="applyIdList"></td>
                      <td class="tn-width-auto"><a title=江苏锐聘信息科技有限公司  href="#" target="_blank"> 江苏锐聘信息科技有限公司</a></td>
                      <th class="tn-width-pic-mini"> <a title=软件开发工程师（提供岗前培训） href="#" target="_blank"> 软件开发工程师...</a> </th>
                      <td class="tn-width-category"><div class="tn-instructions">
                          <div class="it-instructions-tit"> <span style="width: 26px">申请</span><span style="width: 132px">审核</span><span style="width: 132px">通知</span></div>
                          <div class="tn-progress-bar tn-widget-content tn-corner-all">
                            <div style="width: 50%;" class="tn-progress-bar-value tn-widget-header tn-corner-left tn-border-tbl"> </div>
                      ...
                      <td class="tn-width-action2"><span class="tn-action"> <a class="tn-action tn-action-text-icon tnui-apply-delete" href="/Home/Delete?applyId=493"> <span class="tn-icon it-icon-delete"></span><span class="tn-action-text">删除</span></a> </span></td>
                    </tr>
                    <tr class="tn-table-grid-row">
                      <td class="tn-width-check"><input type="checkbox" class="tn-checkbox tnui-apply" value="487" name="applyIdList"></td>
                      <td class="tn-width-auto"><a title=北京日立华胜信息系统有限公司  href="/Company/138" target="_blank"> 北京日立华胜信息系统有限公司</a></td>
                      <th class="tn-width-pic-mini"> <a title=对日软件开发（提供岗前培训） href="/Job/001004005-57" target="_blank"> 对日软件开发（...</a> </th>
                      <td class="tn-width-category"><div class="tn-instructions">
                          <div class="it-instructions-tit"> <span style="width: 26px">申请</span><span style="width: 132px">审核</span><span style="width: 132px">通知</span></div>
                          <div class="tn-progress-bar tn-widget-content tn-corner-all">
                            <div style="width: 50%;" class="tn-progress-bar-value tn-widget-header tn-corner-left tn-border-tbl"> </div>
                      ...
                      <td class="tn-width-action2"><span class="tn-action"> <a class="tn-action tn-action-text-icon tnui-apply-delete" href="/Home/Delete?applyId=487"> <span class="tn-icon it-icon-delete"></span><span class="tn-action-text">删除</span></a> </span></td>
                    </tr>
                    <tr class="tn-table-grid-row">
                      <td class="tn-width-check"><input type="checkbox" class="tn-checkbox tnui-apply" value="486" name="applyIdList"></td>
                      <td class="tn-width-auto"><a title=宏智科技（苏州）有限公司  href="#" target="_blank"> 宏智科技（苏州）有限公司</a></td>
                      <th class="tn-width-pic-mini"> <a title=对日Java软件开发工程师 href="#" target="_blank"> 对日Java软件开...</a> </th>
                      <td class="tn-width-category"><div class="tn-instructions">
                          <div class="it-instructions-tit"> <span style="width: 26px">申请</span><span style="width: 132px">审核</span><span style="width: 132px">通知</span></div>
                          <div class="tn-progress-bar tn-widget-content tn-corner-all">
                            <div style="width: 50%;" class="tn-progress-bar-value tn-widget-header tn-corner-left tn-border-tbl"> </div>
