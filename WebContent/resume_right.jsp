			...
			<div id="resumeSavePreview">
				<div class="it-comment-btn">
					<a id="reviewResume"
						...
						href="resumeView.html" target="_parent" plugin="dialog"> <span
						class="tn-button-text">简历预览</span>
					</a> <a id="saveResume"
			...
			<div id="resumeFull">
				<div class="tn-instructions tn-border-gray tn-border-bottom">
					<p class="tn-progress-text">
						<span class="tn-text-note">简历完整度</span><strong class="tn-action">45%</strong>
					</p>
				...
				<div class="it-editdata-list">
					<ul>
						...
						<li class="tn-editdata-bg"><a class="tn-button-text"
							href="#ResumesHonour">获得证书</a> <span class="tn-icon it-icon-stop"></span>
						</li>
						<li class="tn-editdata-bg"><a class="tn-button-text"
							href="#ResumesTrainExperience"> 培训经历</a> <span
							class="tn-icon it-icon-stop"></span></li>
						<li class="tn-editdata-bg"><a class="tn-button-text"
							href="#ResumesITTec">IT技能</a> <span
							class="tn-icon it-icon-accept"></span></li>
						<li class="tn-editdata-bg"><a class="tn-button-text"
							href="#ResumesOtherInfo">其他信息</a> <span
							class="tn-icon it-icon-stop"></span></li>
						<li class="tn-editdata-bg"><a class="tn-button-text"
